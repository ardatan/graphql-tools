...
describe('Autopublish', () => {
    it('publishes payloads to the channel on mutations', () => {
        ...
        const p1 = new Promise((resolve, reject) => {
            pubsub.subscribe('createSpecies', (data) => {
                added.push(data);
                resolve(undefined);
            });
        });
        ...
        const p2 = new Promise((resolve, reject) => {
            pubsub.subscribe('updateSpecies', (data) => {
                updated.push(data);
                resolve(undefined);
            });
        });
        ...
        const p3 = new Promise((resolve, reject) => {
            pubsub.subscribe('deleteSpecies', (data) => {
                deleted.push(data);
                resolve(undefined);
            });
        });
