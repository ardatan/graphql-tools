...
Also exports shared `isSafeObjectKey` / `isDangerousObjectKey` helpers used by this path walker and other package call sites. `@graphql-tools/merge` and `@graphql-tools/mock` now require `@graphql-tools/utils@^12.0.2` for those helpers.
