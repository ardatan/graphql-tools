---
id: stitch-6-federation
title: Federation SDL to Stitching SDL
sidebar_label: Federation to Stitching
---

`federationToStitchingSDL` utility converts an [Apollo Federation SDL](https://www.apollographql.com/docs/federation/federation-spec/) string into a [Schema Stitching SDL](https://www.graphql-tools.com/docs/stitch-3-directives-sdl/) string.
