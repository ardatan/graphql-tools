...
> Watch [Episode #12 of `graphql.wtf`](https://graphql.wtf/episodes/12-graphql-remote-schema-stitching) for a quick introduction to remote schemas:

<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/gyxYRvfCpAs"
