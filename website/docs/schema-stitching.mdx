...
- [Combining multiple schemas](/docs/schema-stitching/stitch-1-combining-schemas)
- [Merging types across schemas](/docs/schema-stitching/stitch-2-type-merging)
- [Schema extensions](/docs/schema-stitching/stitch-4-schema-extensions)
- [Stitching directives SDL](/docs/schema-stitching/stitch-3-directives-sdl)
