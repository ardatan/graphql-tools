...
- [Combining multiple schemas](/docs/schema-stitching/stitch-combining-schemas)
- [Merging types across schemas](/docs/schema-stitching/stitch-type-merging)
- [Schema extensions](/docs/schema-stitching/stitch-schema-extensions)
- [Stitching directives SDL](/docs/schema-stitching/stitch-directives-sdl)
