---
title: "loadDocuments"
description: "The loadDocuments function exported by @graphql-tools/load."
---

> **loadDocuments**(`pointerOrPointers`, `options`): `Promise`\<[`Source`](/docs/api/utils/src/interfaces/source)[]\>

Defined in: [packages/load/src/documents.ts:32](https://github.com/ardatan/graphql-tools/blob/master/packages/load/src/documents.ts#L32)
