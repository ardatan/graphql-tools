...
description: "The JsonFileLoaderOptions interface exported by @graphql-tools/json-file-loader."
---

Defined in: [packages/loaders/json-file/src/index.ts:23](https://github.com/ardatan/graphql-tools/blob/master/packages/loaders/json-file/src/index.ts#L23)
