...
```graphql title="comments.graphql"
type Comment {
  id: ID!
  text: String!
}
...
[(a fully executable remote schema using @graphql-tools/wrap)](https://the-guild.dev/graphql/stitching/docs/getting-started/remote-subschemas)
from a URL endpoint.
