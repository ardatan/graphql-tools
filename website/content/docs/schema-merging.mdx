...
```js title="graphql/types/clientType.js"
...
```js title="graphql/types/productType.js"
module.exports = /* GraphQL */ `
  type Product {
    id: ID!
    description: String
...
See [`mergeTypeDefs`](/docs/api/merge/src/functions/mergetypedefs) for more details.
...
```graphql title="graphql/types/clientType.graphql"
type Client {
  id: ID!
  name: String
  age: Int
...
```graphql title="graphql/types/productType.graphql"
type Product {
  id: ID!
  description: String
  price: Int
...
```js title="graphql/resolvers/clientResolver.js"
module.exports = {
  Query: {
    clients: () => {},
    client: () => {}
...
```js title="graphql/resolvers/productResolver.js"
module.exports = {
  Query: {
    products: () => {},
    product: () => {}
...
```js title="graphql/resolvers/index.js"
...
```js title="graphql/resolvers/index.js/ts"
const path = require('path')
const { mergeResolvers } = require('@graphql-tools/merge')
const { loadFilesSync } = require('@graphql-tools/load-files')
