---
title: "@graphql-tools/load-files changelog"
sidebarTitle: "@graphql-tools/load-files"
description: "Every release of @graphql-tools/load-files with its changes and the pull requests behind them."
---
