...
export declare type MergeTypeFilter<TContext = Record<string, any>> = (
...
export declare type SubschemaConfigTransform<TContext = Record<string, any>> = (
...
export declare type OnTypeConflict<TContext = Record<string, any>> = (
