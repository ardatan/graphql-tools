 ...
 */
export declare function loadTypedefs<AdditionalConfig = Record<string, unknown>>(
 ...
 * @param options Additional options
 */
export declare function loadTypedefsSync<AdditionalConfig = Record<string, unknown>>(
  pointerOrPointers: UnnormalizedTypeDefPointer | UnnormalizedTypeDefPointer[],
  options: LoadTypedefsOptions<Partial<AdditionalConfig>>
): Source[];
