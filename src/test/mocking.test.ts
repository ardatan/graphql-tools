...
describe('Mock', () => {
  ...
  test('let you mock with preserving resolvers, also when using connectors', () => {
    const resolvers = {
      RootQuery: {
        returnString: () => 'woot!?', // a) resolve of a string
      },
  ...
  test('let you mock with preserving resolvers, also when using both connectors and logger', () => {
    const resolvers = {
      RootQuery: {
        returnString: () => 'woot!?', // a) resolve of a string
      },
