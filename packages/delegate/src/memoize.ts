...
const memoize1of2cache: WeakMap<Record<string, any>, WeakMap<Record<string, any>, any>> = new WeakMap();
export function memoize1of2<F extends (a1: any, a2: any) => any>(fn: F): F {
  return function memoized(a1: any, a2: any): any {
    const cachedValue = memoize1of2cache.get(a1);
    if (cachedValue === undefined) {
      const newValue = fn(a1, a2);
      memoize1of2cache.set(a1, newValue);
      return newValue;
    }
...
const memoize4ofManyCache: WeakMap<Record<string, any>, WeakMap<Record<string, any>, any>> = new WeakMap();
export function memoize4ofMany<F extends (a1: any, a2: any, a3: any, a4: any, ...args: Array<any>) => any>(fn: F): F {
  return function memoized(a1: any, a2: any, a3: any, a4: any, ...args: Array<any>) {
    let cache2 = memoize4ofManyCache.get(a1);
    if (!cache2) {
      cache2 = new WeakMap();
      memoize4ofManyCache.set(a1, cache2);
      const cache3 = new WeakMap();
      cache2.set(a2, cache3);
      const cache4 = new WeakMap();
      cache3.set(a3, cache4);
