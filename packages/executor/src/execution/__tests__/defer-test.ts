...
describe('Execute: defer directive', () => {
  ...
  it('Can defer an inline fragment', async () => {
    ...
    expectJSON(result).toDeepEqual([
      ...
      {
        incremental: [{ data: { name: 'Luke' }, path: ['hero'], label: 'InlineDeferred' }],
        hasNext: false,
      },
    ]);
  });
        ...
        incremental: [
          {
            ...
            errors: [
              {
                message: 'Cannot return null for non-nullable field Hero.nonNullErrorField.',
                locations: [{ line: 9, column: 9 }],
        ...
        incremental: [
          {
            ...
            errors: [
              {
                message: 'Cannot return null for non-nullable field Hero.promiseNonNullErrorField.',
                locations: [{ line: 9, column: 9 }],
