...
import type { GraphQLNamedType, GraphQLNullableType, GraphQLType } from '../type/definition.js';
...
export function typeFromAST(schema: GraphQLSchema, typeNode: TypeNode): GraphQLType | undefined {
  switch (typeNode.kind) {
    ...
    case Kind.NON_NULL_TYPE: {
      const innerType = typeFromAST(schema, typeNode.type) as GraphQLNullableType;
