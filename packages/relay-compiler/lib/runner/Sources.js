...
var Sources = /*#__PURE__*/ (function () {
          ...
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            ...
            !doc.definitions.length
              ? process.env.NODE_ENV !== 'production'
                ? invariant(false, 'expected not empty list of definitions')
                : invariant(false)
              : void 0;
  ...
  _proto.processChanges = function processChanges(baseDir, files) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
        ...
        var oldEntry =
          (_state$file$name$node =
            (_state$file$name = state[_file.name]) === null || _state$file$name === void 0
              ? void 0
              : _state$file$name.nodes) !== null && _state$file$name$node !== void 0
            ? _state$file$name$node
        ...
        if (newDefs != null && newDefs.length > 0) {
              ...
              if (newTexts.has(hashedText)) {
                ...
                switch (_ast.kind) {
                  ...
                  case 'OperationDefinition':
                    name =
                      (_ast$name$value =
                        (_ast$name = _ast.name) === null || _ast$name === void 0
                          ? void 0
                          : _ast$name.value) !== null && _ast$name$value !== void 0
                        ? _ast$name$value
                        : 'unnamed operation';
                    break;
                }
                ...
                throw new Error(
                  'Duplicate definition of `'.concat(name, '` in `').concat(_file.name, '`'),
                );
              }
          ...
          if (hasEntry) {
            ...
            for (
              var _i2 = 0, _Object$keys2 = Object.keys(oldEntry);
  ...
  _proto.nodes = function* nodes() {
    for (var _file2 in this._state) {
      ...
      for (
        var _i3 = 0, _Object$values = Object.values(entry.nodes);
