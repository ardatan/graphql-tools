...
function compileAll(_ref) {
  ...
  var transformedQueryContext = compilerContext.applyTransforms(
    [].concat(
      (0, _toConsumableArray2['default'])(compilerTransforms.commonTransforms),
  ...
  return Profiler.asyncContext(
    ...
    /*#__PURE__*/ _asyncToGenerator(function* () {
      ...
      var _iterator = (0, _createForOfIteratorHelper2['default'])(
          writerConfig.generatedDirectories || [],
        ),
        _step;
      ...
      try {
            ...
            /*#__PURE__*/ (function () {
              var _ref7 = _asyncToGenerator(function* (_ref5) {
                ...
                var typeText = typeNode
                  ? writerConfig.typeGenerator.generate(schema, typeNode, {
                ...
                yield writeRelayGeneratedFile(
                  ...
                  (_writerConfig$repersi = writerConfig.repersist) !== null &&
                    _writerConfig$repersi !== void 0
                    ? _writerConfig$repersi
                    : false,
                  (_writerConfig$writeQu = writerConfig.writeQueryParameters) !== null &&
                    _writerConfig$writeQu !== void 0
                    ? _writerConfig$writeQu
                    : function noop() {},
                  languagePlugin,
                );
              });
        ...
        allOutputDirectories.forEach(function (dir) {
          dir.deleteExtraFiles(
            languagePlugin === null || languagePlugin === void 0
              ? void 0
              : languagePlugin.keepExtraFile,
          );
        });
