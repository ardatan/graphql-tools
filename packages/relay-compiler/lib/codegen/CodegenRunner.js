        ...
        try {
          ...
          if (baseParsers) {
            baseParsers.forEach(function (baseParserName) {
              !(_this5.parsers[baseParserName] != null)
          ...
          var schema = Profiler.run('getSchema', function () {
            return createSchema(
              _this5.parserConfigs[_parser2].getSchemaSource(),
              baseDocuments.toArray(),
              _this5.parserConfigs[_parser2].schemaExtensions,
            );
          });
      ...
      yield CodegenWatcher.watchCompile(
        ...
        /*#__PURE__*/ (function () {
          var _ref4 = _asyncToGenerator(function* (files) {
            !(_this6.parsers[parserName] != null)
              ? process.env.NODE_ENV !== 'production'
                ? invariant(false, 'Trying to watch an uncompiled parser config: %s', parserName)
                : invariant(false)
              : void 0;
