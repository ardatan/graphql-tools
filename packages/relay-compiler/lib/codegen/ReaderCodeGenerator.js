  ...
  if (node.metadata != null) {
    ...
    if (refetch != null && typeof refetch === 'object') {
      ...
      if (typeof refetch.identifierField === 'string') {
        metadata.refetch = (0, _objectSpread2['default'])(
          (0, _objectSpread2['default'])({}, metadata.refetch),
          {},
          {
    ...
    case 'ObjectValue': {
      ...
      return {
        fields: objectKeys.map(function (fieldName) {
          ...
          return (_generateArgument = generateArgument(fieldName, fieldValue)) !== null &&
            _generateArgument !== void 0
            ? _generateArgument
            : {
                kind: 'Literal',
                name: fieldName,
