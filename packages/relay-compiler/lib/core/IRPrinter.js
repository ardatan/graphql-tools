...
function print(schema, node) {
  switch (node.kind) {
    case 'Fragment':
      return (
        'fragment '.concat(node.name, ' on ').concat(schema.getTypeString(node.type)) +
    ...
    case 'SplitOperation':
      return (
        'SplitOperation '.concat(node.name, ' on ').concat(schema.getTypeString(node.type)) +
        printSelections(schema, node, '', {}) +
        '\n'
      );
...
function printSelections(schema, node, indent, options) {
  ...
  return printed.length
    ? ' {\n'
        ...
        .concat(indent)
        .concat(
          (options === null || options === void 0 ? void 0 : options.isClientExtension) === true
            ? '# '
            : '',
          '}',
        )
...
function printField(schema, field, options) {
  ...
  var parentDirectives =
    (_options$parentDirect =
      options === null || options === void 0 ? void 0 : options.parentDirectives) !== null &&
  ...
  return (
    (isClientExtension ? '# ' : '') +
    (field.alias === field.name ? field.name : field.alias + ': ' + field.name) +
...
function printSelection(schema, selection, indent, options) {
  ...
  if (selection.kind === 'LinkedField') {
    ...
    !(value != null)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'IRPrinter: Expected a variable for condition, got a literal `null`.')
        : invariant(false)
      : void 0;
    ...
    if (selection['if'] !== null) {
      ...
      streamStr += ', if: '.concat(
        (_printValue = printValue(schema, selection['if'], null)) !== null && _printValue !== void 0
          ? _printValue
          : '',
      );
    }
    ...
    if (selection.initialCount !== null) {
      ...
      streamStr += ', initial_count: '.concat(
        (_printValue2 = printValue(schema, selection.initialCount, null)) !== null &&
          _printValue2 !== void 0
          ? _printValue2
          : '',
      );
    ...
    if (selection.useCustomizedBatch !== null) {
      ...
      streamStr += ', use_customized_batch: '.concat(
        (_printValue3 = printValue(schema, selection.useCustomizedBatch, null)) !== null &&
          _printValue3 !== void 0
          ? _printValue3
          : 'false',
      );
    ...
    if (selection['if'] !== null) {
      ...
      deferStr += ', if: '.concat(
        (_printValue4 = printValue(schema, selection['if'], null)) !== null &&
          _printValue4 !== void 0
          ? _printValue4
          : '',
      );
  ...
  var printed = field.handles.map(function (handle) {
    ...
    var handleArgs =
      handle.handleArgs == null
        ? ''
        : ', handleArgs: '.concat(printArguments(schema, handle.handleArgs));
...
function printLiteral(schema, value, type) {
  if (value == null) {
    ...
    return (_JSON$stringify = JSON.stringify(value)) !== null && _JSON$stringify !== void 0
      ? _JSON$stringify
      : 'null';
  }
  ...
  if (type && schema.isEnum(type)) {
    ...
    !(typeof result === 'string')
      ? process.env.NODE_ENV !== 'production'
        ? invariant(
            ...
            (_JSON$stringify2 = JSON.stringify(value)) !== null && _JSON$stringify2 !== void 0
              ? _JSON$stringify2
              : 'null',
          )
        : invariant(false)
    ...
    return (_JSON$stringify3 = JSON.stringify(value)) !== null && _JSON$stringify3 !== void 0
      ? _JSON$stringify3
      : '';
    ...
    return (_JSON$stringify4 = JSON.stringify(_result)) !== null && _JSON$stringify4 !== void 0
      ? _JSON$stringify4
      : '';
  } else if (Array.isArray(value)) {
    !(type && schema.isList(type))
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'IRPrinter: Need a type in order to print arrays.')
        : invariant(false)
      : void 0;
    ...
    !(type && schema.isInputObject(type))
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'IRPrinter: Need an InputObject type to print objects.')
        : invariant(false)
      : void 0;
    ...
    return (_JSON$stringify5 = JSON.stringify(value)) !== null && _JSON$stringify5 !== void 0
      ? _JSON$stringify5
      : 'null';
  }
}
