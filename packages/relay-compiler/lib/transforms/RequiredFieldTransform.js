...
function visitInlineFragment(fragment, state) {
  ...
  var parentAbstractInlineFragment =
    (_state$parentAbstract = state.parentAbstractInlineFragment) !== null &&
    _state$parentAbstract !== void 0
      ? _state$parentAbstract
      : getAbstractInlineFragment(fragment, state.schema); // $FlowFixMe[incompatible-use]
...
function vistitScalarField(field, state) {
  var pathName = []
    .concat((0, _toConsumableArray2['default'])(state.path), [field.alias])
    .join('.');
...
function addChildrenCanBubbleMetadata(node, state) {
  var _iterator = (0, _createForOfIteratorHelper2['default'])(
      state.currentNodeRequiredChildren.values(),
    ),
    _step;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      if (requiredMetadata != null && requiredMetadata.action !== 'THROW') {
        var metadata = (0, _objectSpread2['default'])(
...
function assertCompatibleNullability(field, pathName, pathRequiredMap) {
  ...
  if (
    (requiredMetadata === null || requiredMetadata === void 0
      ? void 0
      : requiredMetadata.action) ===
    (existingRequiredMetadata === null || existingRequiredMetadata === void 0
      ? void 0
      : existingRequiredMetadata.action)
  ) {
    return;
  }
  ...
  if (requiredMetadata == null) {
    throw createUserError(
      'The field "'.concat(field.alias, '" is @required in [1] but not in [2].'),
  ...
  throw createUserError(
    'The field "'.concat(field.alias, '" has a different @required action in [1] than in [2].'),
...
function getRequiredDirectiveMetadata(field) {
  ...
  return (_field$metadata = field.metadata) === null || _field$metadata === void 0
    ? void 0
    : _field$metadata.required;
      ...
      if (!previouslyRequiredChildren.has(path)) {
        ...
        if (otherParent == null) {
          throw createCompilerError(
            'Could not find other parent node at path "'.concat(fieldPath, '".'),
            [childField.loc],
          );
        }
...
function createMissingRequiredFieldError(requiredChild, missingParent) {
  ...
  return createUserError(
    'The field "'.concat(alias, '" is marked as @required in [1] but is missing in [2].'),
...
function applyDirectives(field, pathName, documentName) {
  ...
  if (!featureIsEnabled(documentName)) {
    throw new createUserError( // Purposefully don't include details in this error message, since we
      ...
      requiredDirectives.map(function (x) {
        return x.loc;
      }),
    );
  }
  ...
  if (arg == null) {
    throw createUserError('The @required directive requires an `action` argument.', [
  ...
  return (0, _objectSpread2['default'])(
    ...
    {},
    {
      ...
      metadata: (0, _objectSpread2['default'])(
        (0, _objectSpread2['default'])({}, field.metadata),
        {},
        {
          required: {
