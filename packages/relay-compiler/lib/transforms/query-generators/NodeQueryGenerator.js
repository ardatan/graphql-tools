      ...
      Array.from(schema.getPossibleTypes(schema.assertAbstractType(fragment.type))).every(
        function (possibleType) {
          return schema.implementsInterface(
            ...
            schema.assertInterfaceType(schema.expectTypeFromString(NODE_TYPE_NAME)),
          );
        },
      ));
...
function enforceIDField(schema, fragment) {
  ...
  var generatedIDSelection = idField
  ...
  return (0, _objectSpread2['default'])(
    ...
    {},
    {
      selections: [].concat((0, _toConsumableArray2['default'])(fragment.selections), [
        generatedIDSelection,
      ]),
    },
  );
}
